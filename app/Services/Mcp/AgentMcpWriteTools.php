...
final readonly class AgentMcpWriteTools
{
    ...
    public function documentsUpload(
        ...
        #[Schema(maxLength: 255)] ?string $title,
        string $document_type,
        #[Schema(description: 'Document date or datetime accepted by the PHR API.')] ?string $observed_at,
        #[Schema(maxLength: 20000)] ?string $summary,
